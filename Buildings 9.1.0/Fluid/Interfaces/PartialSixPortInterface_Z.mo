...
partial model PartialSixPortInterface_Z
  "Partial model transporting fluid between six ports without storing mass or energy"
  extends Buildings.Fluid.Interfaces.PartialSixPort_Z;
  ...
  parameter Modelica.Units.SI.MassFlowRate m1_flow_nominal(min=0)
    "Nominal mass flow rate" annotation (Dialog(group="Nominal condition"));
  parameter Modelica.Units.SI.MassFlowRate m2_flow_nominal_GCon(min=0)
    "Nominal mass flow rate" annotation (Dialog(group="Nominal condition"));
  parameter Modelica.Units.SI.MassFlowRate m2_flow_nominal_GEva(min=0)
    "Nominal mass flow rate" annotation (Dialog(group="Nominal condition"));
  ...
  "Small mass flow rate for regularization of zero flow"
    ...
    "Small mass flow rate for regularization of zero flow"
    annotation(Dialog(tab = "Advanced"));
  parameter Medium2.MassFlowRate m2_flow_small(min=0) = 1E-4*abs(m2_flow_nominal_GCon)
    "Small mass flow rate for regularization of zero flow"
    annotation(Dialog(tab = "Advanced"));
  // Diagnostics
  ...
  Modelica.Units.SI.PressureDifference dp3(displayUnit="Pa") = port_a3.p - port_b3.p
