...
partial model PartialSixPort_Z "Partial model with Six ports"
  ...
  parameter Boolean allowFlowReversal3 = true
    "= false to simplify equations, assuming, but not enforcing, no flow reversal for medium 3"
    annotation(Dialog(tab="Assumptions"), Evaluate=true);
  ...
  Modelica.Fluid.Interfaces.FluidPort_b port_b3(
    ...
    annotation (Placement(transformation(extent={{-86,-76},{-106,-56}})));
  annotation (
    preferredView="info",
