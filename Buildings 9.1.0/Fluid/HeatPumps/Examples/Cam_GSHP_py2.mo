...
model Cam_GSHP_py2
  ...
  Modelica.Fluid.Sensors.TemperatureTwoPort Gro_Ent_T(redeclare package Medium =
        Medium2)
  ...
  Buildings.Utilities.IO.Python_3_8.Real_Real add2(
    nDblWri=3,
    nDblRea=2,
    functionName="random",
    moduleName="GroundHX",
    samplePeriod=800,
    passPythonObject=true) "add 2 degree after ground heat exchanger"
    annotation (Placement(transformation(extent={{-4,-104},{16,-84}})));
  ...
  Modelica.Fluid.Sensors.MassFlowRate massFlowRate(redeclare package Medium =
    ...
    annotation (Placement(transformation(extent={{78,-30},{66,-20}})));
equation
  ...
  connect(booCoo.y, heaPum.y_GroEva) annotation (Line(points={{-137,54},{-24,54},
          {-24,16},{0,16},{0,8.16667},{9.28571,8.16667}}, color={0,0,127}));
  ...
  connect(modTim.y, multiplex3_1.u3[1]) annotation (Line(points={{-111,-98},{
          -108,-98},{-108,-101},{-64,-101}}, color={0,0,127}));
  connect(Gro_Ent_T.T, multiplex3_1.u1[1]) annotation (Line(points={{-35,0.5},{
          -35,2},{-74,2},{-74,-87},{-64,-87}}, color={0,0,127}));
  connect(combiTimeTable.y[1], sou2.T_in) annotation (Line(points={{-239,-70},{
          -204,-70},{-204,-114},{152,-114},{152,-72},{154,-72},{154,12},{72,12}},
        color={0,0,127}));
  connect(multiplex3_1.y, add2.uR)
    annotation (Line(points={{-41,-94},{-6,-94}}, color={0,0,127}));
  connect(sou2.ports[1], massFlowRate.port_a) annotation (Line(points={{50,8},{
          44,8},{44,-8},{84,-8},{84,-25},{78,-25}}, color={0,127,255}));
  connect(massFlowRate.port_b, heaPum.port_a2) annotation (Line(points={{66,-25},
          {36,-25},{36,10.3333},{23.7143,10.3333}}, color={0,127,255}));
  connect(massFlowRate.m_flow, multiplex3_1.u2[1]) annotation (Line(points={{72,
          -19.5},{72,-54},{62,-54},{62,-90},{-58,-90},{-58,-28},{-82,-28},{-82,
          -94},{-64,-94}}, color={0,0,127}));
