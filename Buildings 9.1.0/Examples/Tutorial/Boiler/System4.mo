...
<p>This part of the system model adds to the model that is implemented in <a href=\"modelica://Buildings.Examples.Tutorial.Boiler.System3\">Buildings.Examples.Tutorial.Boiler.System3</a> closed loop control for the pumps and the boiler. The control valves are still open loop control. </p>
<h4>Implementation</h4>
<p>This model was built as follows: </p>
<ol>
<li>First, we copied the model <a href=\"modelica://Buildings.Examples.Tutorial.Boiler.System3\">Buildings.Examples.Tutorial.Boiler.System3</a> and called it <span style=\"font-family: Courier New;\">Buildings.Examples.Tutorial.Boiler.System4</span>. </li>
<li>Next, we added the outdoor temperature sensor <span style=\"font-family: Courier New;\">senTOut</span>, which we will use to disable the plant when the outdoor temperature is warmer than <i>17</i>&deg;C. This is implemented by the instances <span style=\"font-family: Courier New;\">hysTOut</span> and <span style=\"font-family: Courier New;\">not2</span>, whose output signal is connected to the block <span style=\"font-family: Courier New;\">and1</span> as shown in the figure below. </li>
<p align=\"center\"><img src=\"modelica://Buildings/Resources/Images/Examples/Tutorial/Boiler/System4PlantOnOff.png\" alt=\"image\"/> </p>
<li>Similar to the control of the radiator pump, we used a boolean to real converter, followed by a first order filter, to set the mass flow rate of the boiler pump. </li>
<li>Next, for the boiler on/off control, we use again a hysteresis block (instance <span style=\"font-family: Courier New;\">hysTBoi</span>), which we configured as </li>
</ol>
<p><span style=\"font-family: Courier New;\">  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hysTBoi(uLow=273.15 + 70,</span></p>
<p><span style=\"font-family: Courier New;\">                                                           uHigh=273.15 + 90)</span></p>
<p><span style=\"font-family: Courier New;\">    &quot;Hysteresis for on/off of boiler&quot;;</span></p>
<p>The output of the hysteresis block is sent to the instance <span style=\"font-family: Courier New;\">not3</span>, which negates its input signal. The output signal of the <span style=\"font-family: Courier New;\">not3</span> instance is then sent to the <span style=\"font-family: Courier New;\">and2</span> block, which ensures that the boiler is only on when the pumps are on and the temperature is below <i>70</i>&deg;C, and that the boiler is off if its temperature reaches <i>90</i>&deg;C. Therefore, the boiler control sequence is as shown below. </p>
<p align=\"center\"><img src=\"modelica://Buildings/Resources/Images/Examples/Tutorial/Boiler/System4BoilerOnOff.png\" alt=\"image\"/> </p>
<p>This completes the closed loop control of the boiler and the pumps. When simulating the model for <i>2</i> days, or <i>172800</i> seconds, the response shown below should be seen. </p>
<p align=\"center\"><img src=\"modelica://Buildings/Resources/Images/Examples/Tutorial/Boiler/System4Temperatures.png\" alt=\"image\"/> </p>
<p>The figure shows that the return water temperature <span style=\"font-family: Courier New;\">temRet.T</span> is below <i>50</i>&deg;C for quite some time when the system heats up. Furthermore, the supply water temperature <span style=\"font-family: Courier New;\">temSup.T</span> is oscillating with the boiler temperature. We will fix these issues by adding closed loop control for the valves in model <a href=\"modelica://Buildings.Examples.Tutorial.Boiler.System5\">Buildings.Examples.Tutorial.Boiler.System5</a>. </p>
</html>", revisions="<html>
<ul>
<li>
